...
for (const folder of validatorFolders) {
    const files = (0, fs_1.readdirSync)((0, path_1.join)(__dirname, `../src/core/r4/validators/${folder}`));
    const exports = files
        .filter((file) => file !== 'index.ts')
        .map((file) => {
        const moduleName = (0, path_1.basename)(file, '.ts');
        ...
        .join('\n');
    const indexPath = (0, path_1.join)(__dirname, `../src/core/r4/validators/${folder}/index.ts`);
    (0, fs_1.writeFileSync)(indexPath, exports);
}
/*
