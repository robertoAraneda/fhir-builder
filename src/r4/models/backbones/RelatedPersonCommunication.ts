...
import { IRelatedPersonCommunication, IOperationOutcome } from 'fhirtypes/dist/r4';
...
/**
  ...
  * @description Class for RelatedPersonCommunication BackboneElement
  undefined
...
export class RelatedPersonCommunication
  ...
  implements IRelatedPersonCommunication, IValidatable, ISerializable
{
  /**
  ...
  validate(): { isValid: boolean; operationOutcome: IOperationOutcome } {
    return ConformanceValidator('RelatedPersonCommunication', this);
  }
