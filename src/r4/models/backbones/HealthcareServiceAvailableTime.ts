...
import { IHealthcareServiceAvailableTime, IOperationOutcome } from 'fhirtypes/dist/r4';
...
/**
  ...
  * @description Class for HealthcareServiceAvailableTime BackboneElement
  undefined
...
export class HealthcareServiceAvailableTime
  ...
  implements IHealthcareServiceAvailableTime, IValidatable, ISerializable
{
  /**
   ...
   */
  toString(): string {
    return `HealthcareServiceAvailableTime${JSON.stringify(this.toJson())}`;
  }
  ...
  toPrettyString(): string {
    return `HealthcareServiceAvailableTime${JSON.stringify(this.toJson(), null, 2)}`;
  }
  ...
  validate(): { isValid: boolean; operationOutcome: IOperationOutcome } {
    return ConformanceValidator('HealthcareServiceAvailableTime', this);
  }

  constructor(args?: IHealthcareServiceAvailableTime) {
    super();
