import { IOperationOutcomeIssue, IPatientLink } from 'fhirtypes/dist/r4';
...
export const modelFields = createBackboneDefinition<IPatientLink>([
  ...
  { name: 'type', type: 'code', isArray: false, isRequired: true, enumValues: linkTypesValues },
  { name: '_type', type: 'Element', isArray: false, isRequired: false },
]);

export function PatientLinkValidator(
  dataToValidate: IPatientLink,
  path = 'PatientLink',
