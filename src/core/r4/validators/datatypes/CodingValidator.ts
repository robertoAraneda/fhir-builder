...
const modelFields = createDatatypeDefinition<ICoding>([
  ...
  { name: '_display', type: 'Element', isArray: false, isRequired: false },
  { name: '_userSelected', type: 'Element', isArray: false, isRequired: false },
]);

export const CodingValidator = (dataToValidate: ICoding, path = 'Coding', errors: IOperationOutcomeIssue[]): void => {
